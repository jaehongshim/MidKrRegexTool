...
from .annotation import extract_infl_from_gold
from .model import Token
from .tagger import contains_han, split_lem_infl
...
def candidate_generator(
    token: Token, rules: list[str], *, infl_decomp: dict[str, str] | None = None
) -> list[str]:
